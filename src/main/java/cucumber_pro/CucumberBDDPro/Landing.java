...
public class Landing extends Base{
	...
	public WebElement clickOnSelectBtnInQA()
	{
		By var_clickOnSelectBtnInQA = By.xpath("/html/body/div[4]/div/div[2]/div/div[2]/div[2]/div/div/div/div/div/div/div/div/div/table/tbody/tr[2]/td[4]/button");
			return driver.findElement(var_clickOnSelectBtnInQA);
	}		
